...
public:
	...
	Model* LoadModel(void* device, std::string filePath);
	//Load a texture from the given filepath
	Texture* LoadTexture(void* device, std::string filePath);
...
private:
	...
	//Map to hold all loaded models
	std::map<std::string, Model*> modelMap;
	//Map to hold all loaded textures
